...
module myproject_zeropad2d_cl_array_array_ap_fixed_16u_config22_Pipeline_PadTopWidth (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign icmp_ln53_fu_54_p2 = ((ap_sig_allocacmp_j_7 == 4'd10) ? 1'b1 : 1'b0);

assign j_8_fu_60_p2 = (ap_sig_allocacmp_j_7 + 4'd1);

assign layer22_out_din = 160'd0;

assign layer22_out_write = layer22_out_write_local;

endmodule //myproject_zeropad2d_cl_array_array_ap_fixed_16u_config22_Pipeline_PadTopWidth
