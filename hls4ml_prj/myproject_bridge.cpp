...
void myproject_float(
    ...
    hls::stream<result_t> layer69_out_ap("layer69_out");

    myproject(global_in_ap,layer69_out_ap);

    nnet::convert_data<result_t, float, N_LAYER_68>(layer69_out_ap, layer69_out);
}

void myproject_double(
    double global_in[N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1],
    double layer69_out[N_LAYER_68]
) {
    ...
    nnet::convert_data<result_t, double, N_LAYER_68>(layer69_out_ap, layer69_out);
}
}
